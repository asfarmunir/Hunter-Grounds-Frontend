      ...
      <AlertDialogContent className="p-0 pb-10 transition-all dark:bg-[#161313CC] border-none 2xl:min-w-[600px]">
        ...
        <div className="p-6 flex flex-col items-center">
          ...
          <p className=" text-start text-sm 2xl:text-base">
            ...
            10 business days following the request, via PayPal. Please make sure
            you have entered the correct PayPal email address on the request.{" "}
            <br /> <br /> Taxes collected on the sale are transfered to you upon
            withdrawal. Each host is responsible for filing their own respective
