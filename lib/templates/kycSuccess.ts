...
@media (max-width:441px)  { 
  ...
  <body style="word-spacing:normal;background-color:#eeeeee;">
      ...
      >Congratulations! Your KYC (Know Your Customer) verification has been successfully completed.
</br></br>
    You now have full access to all features and services on HuntGrounds. Thank you for completing this important step to ensure the security and compliance of our platform.
</br></br>
If you have any questions or need assistance, feel free to contact us at help@huntgrounds.com.
  
  </br></br>
Welcome to the HuntGrounds community!
