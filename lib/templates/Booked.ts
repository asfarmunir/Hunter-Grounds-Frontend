...
@media (max-width:441px)  { 
  ...
  <body style="word-spacing:normal;background-color:#eeeeee;">
      ...
      <img
         height="auto" src="https://res.cloudinary.com/unionwealthmanagement/image/upload/v1732565750/email%20images/Hunt%20Ground%20EMails/icons/Great_news_zo8zmj.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="560"
      />
      ...
      >
        ...
        <!--[if mso | IE]></v:textbox></v:rect></td></tr></table></td></tr><tr><td class="" width="600px" ><table align="center" border="0" cellpadding="0" cellspacing="0" class="" role="presentation" style="width:560px;" width="560" ><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><![endif]-->
      ...
      >
        <tr>
            ...
            <td style="padding:0px 10px; color:#ffffff" >Booking Nights<br></br>
           <span style="font-size:22px;line-height: 1.6;"> ${totalNights}  </span>
            </td>
          </tr>
      </table>
      ...
      >
        <tr>
            ...
            <td style="padding:0px 10px;color:#ffffff" >Contact Info<br></br>
           <span style="font-size:22px;line-height: 1.6;"> ${BookingPersonEmail} </span>
            </td>
          </tr>
      </table>
