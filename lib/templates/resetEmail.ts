...
@media (max-width:441px)  { 
  ...
  <body style="word-spacing:normal;background-color:#eeeeee;">
      ...
      <img
         height="auto" src="https://res.cloudinary.com/unionwealthmanagement/image/upload/v1732565749/email%20images/Hunt%20Ground%20EMails/icons/Password_Reset_iqhle1.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="560"
      />
      ...
      >
        <tr>
            ...
            <td style="padding:0px 10px;color:#ffffff" >Reset Here</br>
           <a href="${resetLink}" style="font-size:22px;line-height: 1.6;"> Click Here </a>
            </td>
          </tr>
      </table>
